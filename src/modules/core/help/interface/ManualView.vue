...
/* Visual unificado com a nova Central de Ajuda */
.manual-experience,
.manual-experience *,
.manual-experience *::before,
.manual-experience *::after { box-sizing: border-box; }
.manual-experience { --manual-blue: var(--accent-blue); grid-template-columns: 300px minmax(0, 1fr); background: radial-gradient(circle at 84% 0, rgba(var(--accent-blue-rgb), .055), transparent 28%), var(--main-bg); }
.manual-rail { padding: 24px 18px 18px; background: color-mix(in srgb, var(--sidebar-bg) 94%, var(--accent-blue)); box-shadow: 12px 0 36px rgba(16, 29, 74, .04); }
.rail-brand { padding: 0 8px 22px; gap: 13px; }.rail-brand-icon { width: 46px; height: 46px; border-radius: 14px; background: linear-gradient(145deg, var(--accent-blue), var(--accent-blue-dark)); }.rail-brand span { font-size: 12px; }.rail-brand strong { font-size: 16px; }
.rail-progress { margin: 20px 5px 14px; padding: 16px; border-radius: 16px; }.rail-progress-label { font-size: 12px; }.rail-progress small { font-size: 11px; }.rail-progress-track { height: 6px; margin: 10px 0 8px; }
.rail-nav { gap: 5px; }.rail-nav-item { min-height: 56px; padding: 9px 10px; grid-template-columns: 38px minmax(0, 1fr) 18px; gap: 10px; border-radius: 13px; }.rail-nav-icon { width: 38px; height: 38px; border-radius: 11px; }.rail-nav-copy strong { font-size: 13px; }.rail-nav-copy small { margin-top: 2px; font-size: 11px; }.rail-footer { padding: 14px; font-size: 11px; }
.manual-workspace { padding: 22px clamp(24px, 4vw, 62px) 64px; }.manual-workspace > * { max-width: 1120px; }.manual-topline { margin-bottom: 20px; }.manual-breadcrumb, .manual-close { font-size: 12px; }.manual-close { min-height: 38px; padding: 8px 13px; border-radius: 10px; }
.manual-hero { min-height: 270px; padding: 40px 46px; border: 1px solid rgba(89, 137, 205, .28); border-radius: 28px; background: linear-gradient(125deg, #07182f 0%, #0b2851 55%, #123e73 100%); box-shadow: 0 24px 58px rgba(8, 28, 59, .2); }.hero-copy { max-width: 690px; }.hero-kicker { color: #7fc8ff; font-size: 10px; }.hero-copy h1 { margin: 11px 0 10px; font-size: clamp(35px, 4vw, 48px); }.hero-copy p { font-size: 15px; }.hero-metrics { margin-top: 25px; }.hero-metrics strong { font-size: 19px; }.hero-metrics span { font-size: 10px; }
.search-wrap { height: 64px; margin-top: -20px; padding: 0 19px; gap: 13px; border-radius: 17px; box-shadow: 0 16px 34px rgba(25, 51, 75, .13); }.search-wrap input { font-size: 14px; }.search-shortcut { padding: 5px 8px; font-size: 10px; }.search-clear { width: 32px; height: 32px; }
.quick-start, .manual-content { margin-top: 40px; }.block-heading { margin-bottom: 16px; }.block-heading span, .guide-heading-copy > span, .manual-empty > span { font-size: 10px; }.block-heading h2, .guide-heading h2 { font-size: 25px; }.block-heading p { max-width: 430px; font-size: 13px; }
.quick-grid { gap: 15px; }.quick-card { min-height: 92px; padding: 18px; grid-template-columns: 49px minmax(0, 1fr) 31px; gap: 13px; border-radius: 17px; }.quick-card-icon { width: 49px; height: 49px; border-radius: 14px; }.quick-card-copy strong { font-size: 14px; }.quick-card-copy small { margin-top: 4px; font-size: 11px; }.quick-card-arrow { width: 31px; height: 31px; }
.result-banner { margin-top: 30px; padding: 14px 16px; border-radius: 14px; font-size: 12px; }.result-banner button, .guide-actions button { font-size: 11px; }
.guide-heading { margin-bottom: 18px; grid-template-columns: 54px minmax(0, 1fr) auto; gap: 16px; }.guide-heading-icon { width: 54px; height: 54px; border-radius: 16px; }.guide-heading-copy h2 { font-size: 24px; }.guide-heading-copy p { margin-top: 4px; font-size: 13px; }.guide-actions span { font-size: 10px; }
.guide-panels { gap: 11px; }.guide-panels :deep(.v-expansion-panel) { border-radius: 17px !important; }.guide-panels :deep(.v-expansion-panel-title) { min-height: 86px; padding: 15px 20px; }.guide-panels :deep(.v-expansion-panel-text__wrapper) { padding: 0 25px 26px 102px; }
.guide-topic { grid-template-columns: 28px 46px minmax(0, 1fr) auto; gap: 13px; }.guide-topic-number { font-size: 10px; }.guide-topic-icon { width: 46px; height: 46px; border-radius: 13px; }.guide-topic-copy strong { font-size: 14px; }.guide-topic-copy small { margin-top: 4px; font-size: 12px; }.read-chip { font-size: 9px; }
.topic-body-label { margin: 19px 0 14px; font-size: 13px; }.topic-step { min-height: 45px; grid-template-columns: 30px minmax(0, 1fr); gap: 12px; font-size: 13px; }.topic-step > span { width: 29px; height: 29px; font-size: 10px; }.topic-step:not(:last-child)::after { left: 14px; top: 29px; }.topic-detail { grid-template-columns: 21px minmax(0, 1fr); font-size: 13px; }.topic-callout { padding: 14px 15px; font-size: 12px; }.topic-footer span { font-size: 11px; }
.manual-empty h2 { font-size: 25px; }.manual-empty p { font-size: 13px; }
@media (max-width: 1120px) { .manual-experience { grid-template-columns: 252px minmax(0, 1fr); }.quick-grid { grid-template-columns: 1fr; }.quick-card-copy small { white-space: normal; }.hero-art { opacity: .42; } }
@media (max-width: 780px) { .manual-experience { grid-template-columns: 1fr; }.manual-rail { padding: 11px 13px; }.rail-nav-item { min-height: 44px; }.manual-workspace { padding: 16px 16px 44px; }.manual-hero { padding: 30px; }.guide-panels :deep(.v-expansion-panel-text__wrapper) { padding: 0 18px 22px; } }
@media (max-width: 560px) { .manual-hero { min-height: 245px; padding: 26px 23px 36px; }.hero-copy h1 { font-size: 32px; }.guide-heading { grid-template-columns: 47px minmax(0, 1fr); }.guide-heading-icon { width: 47px; height: 47px; }.guide-topic { grid-template-columns: 40px minmax(0, 1fr); }.guide-topic-icon { width: 40px; height: 40px; } }
</style>
